			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?PHP echo base_url();?>admin/employee_management/add">Add Employee</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Employee Management:   </h2>
						<div class="box-icon">
				...
				echo '<tr><td colspan="3">NotFound!</td></tr>';
				  ...
				  $i=1;foreach ($data->result() as $result)
				   ...
				   {?>
                             ...
                             <tr>
                                    <td><?PHP echo $i;?></td>
                                    <td class="center"><?PHP echo $result->emp_name ;?></td>
                                   ...
                                   <a href="javascript:void(0);"  
                                    ...
                                    <td class="center"> 
                                        <a class="btn btn-info" href="<?PHP  echo base_url().'admin/employee_management/edit/'.$result->id;?>">
                                            <i class="icon-edit icon-white"></i>  
                                            	Edit                                            
                                        </a>
                                        <a class="btn btn-danger" href="<?PHP  echo base_url().'admin/employee_management/delete/'.$result->id;?>">
