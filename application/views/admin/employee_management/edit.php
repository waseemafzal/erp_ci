			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?PHP echo base_url();?>admin/employee_management/view">View Employee</a>
					</li>
				</ul>
			</div>
            <?PHP if(isset($msg)){?>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
                   ...
                   <form  name="f1" enctype="multipart/form-data"  method="post"   action="<?PHP echo base_url();?>admin/employee_management/update/<?PHP if(isset($row)) echo $row->id;?>"  class="form-horizontal">
						   <?PHP  echo validation_errors(); ?>
                          <fieldset>
							<!--<legend>Datepicker, Autocomplete, WYSIWYG</legend>-->
                              
							<div class="control-group">
							  <label class="control-label" for="typeahead">Emp Name </label>
							  <div class="controls">
                              
								<input type="text" class="span6 typeahead"  name="emp_name" id="emp_name"  data-provide="typeahead" data-items="4" 
                                value="<?PHP if(isset($row)) echo $row->emp_name;?>" >
