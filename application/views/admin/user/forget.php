...
<head>
	<meta charset="utf-8">
	<title>CherryQ8.com - admin panel</title>
...
<body>
			...
			<div class="row-fluid">
				<div class="well span5 center login-box" style=" width:51.171%;">
                    ...
                    <?PHP }?> 
					<form class="form-horizontal" action="<?PHP echo base_url();?>admin/forget/isvalidemail" method="post">
						...
						<fieldset>
							<div class="input-prepend" title="Username" data-rel="tooltip">
                               ...
                               <input autofocus class="input-large span10" name="email" id="email" type="text" 
                               value="<?PHP echo $this->input->post('email');?>"  placeholder="Email...."/>
							</div>
							...
							<div class="clearfix"></div>
                             <p class="center span5">
								<a href="<?PHP echo base_url();?>admin/">Login Now ?</a>
							</p>
