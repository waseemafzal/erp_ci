			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?PHP echo base_url();?>admin/location/view">View Companies</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
                   ...
                   <form  name="f1"  method="post"   action="<?PHP echo base_url();?>admin/location/update/id/<?PHP echo $row->id;?>"  class="form-horizontal">
