			...
			<div class="row-fluid sortable">
				<div class="box span12">
                   ...
                   <form  name="f1"  method="post" enctype="multipart/form-data"   action="<?PHP echo base_url();?>admin/menu/saveMenuOption"  class="form-horizontal">
						   <?PHP  echo validation_errors(); ?>
                          <fieldset>
                           <!--<div class="control-group">
								<label class="control-label" for="selectError">Select Program Category</label>
								<div class="controls">
                            ...
                            <div class="control-group">
                            <label class="control-label" for="fileInput">Chose image</label>
                            <div class="controls">
                            ...
                            <div id="images_Field_Cover">
                                <div class="control-group">
                                    <label class="control-label" for="fileInput">Chose Thumnail Img</label>
                                    <div class="controls">
