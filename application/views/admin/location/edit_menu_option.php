			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?PHP echo base_url();?>admin/menu/view">View Catgeories</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Edit Sub Category</h2>
						<div class="box-icon">
                   ...
                   <form  name="f1"  method="post"   action="<?PHP echo base_url();?>admin/menu/update/id/<?PHP echo $row->id;?>"  class="form-horizontal">
