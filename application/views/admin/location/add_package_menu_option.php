			...
			<div class="row-fluid sortable">
				<div class="box span12">
                   ...
                   <form  name="f1"  method="post"   action="<?PHP echo base_url();?>admin/menu/savePackageMenu"  class="form-horizontal">
                          ...
                          <fieldset>
                           ...
                           <div class="control-group">
							...
							<div class="form-actions">
                             <input type="hidden"   name="package_id" id="package_id"  value="<?PHP if(isset($package_id)) echo $package_id;?>" >  
