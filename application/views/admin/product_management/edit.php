			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Edit product name</h2>
						<div class="box-icon">
                   ...
                   <form  name="f1" enctype="multipart/form-data"  method="post"   action="<?PHP echo base_url();?>admin/product_management/update/<?PHP if(isset($row)) echo $row->id;?>"  class="form-horizontal">
                          ...
                          <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
                                ...
                                value="<?PHP if(isset($row)) echo $row->product_name;?>" >
