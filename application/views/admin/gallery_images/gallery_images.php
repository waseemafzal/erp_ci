<?PHP //die('nnnnnnnnnnnnnnnnn');?>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>Add <?PHP echo $data->title;?></h2>
						<div class="box-icon">
 ...
 <form name="f1" method="post" action="<?PHP echo base_url();?>admin/gallery_images/save/id/<?PHP echo $data->id;?>/url/<?PHP echo $url;?>"  class="form-horizontal" enctype="multipart/form-data">
				    ...
				    if($counter ==0){ echo $full_upload_msg;}
                       ...
                       <?PHP }?>
                            ...
                            <input class="input-file uniform_on"  type="hidden" name="max_height" value="<?PHP echo $data->max_width;?>">
                             <input class="input-file uniform_on"  type="hidden" name="id" value="<?PHP echo $data->id;?>">
