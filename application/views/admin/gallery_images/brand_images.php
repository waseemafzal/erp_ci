<?PHP //die('nnnnnnnnnnnnnnnnn');?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?PHP echo $back_link;?>">Back to Brand</a>
					</li>
				</ul>
			</div>
 ...
 <form name="f1" method="post" action="<?PHP echo base_url();?>admin/product_images/save/id/<?PHP echo $id;?>/url/<?PHP echo $url;?>"  class="form-horizontal" enctype="multipart/form-data">
                          ...
                          <fieldset>
						 <?PHP  
				 	echo 'data count is->'.$data->count ; echo '</br>';
					echo 'upload_count is->'.$upload_count ; echo '</br>';
					echo $counter  =  $data->count - $upload_count;
