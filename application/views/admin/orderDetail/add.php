			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?PHP echo base_url();?>admin/orderDetail/vieworderlist">View Orders</a>
					</li>
				</ul>
			</div>
                 ...
                 $i=1;foreach ($emp_data->result() as $result) {?>
                  ...
                  <?PHP };?>
						  ...
						  <tbody id="inv_detail">
                            <tr>
                                <td>1</td>
                                <td><input type="text" class="span12 product_name"  name="product_name[]" id="product_name" ></td>
