...
//	$("input:checkbox, input:radio, input:file").not('[data-no-uniform="true"],#uniform-is-ajax').uniform();
	...
	$('ul.gallery li').hover(function(){
		var id = $(this).attr('id');
		var g_id = $(this).attr('title');
		var url = $(this).attr('value');
		//alert('id is'+id);
		
		var base_url = document.getElementById('base_url').value; 
		var url = base_url+'gallery_images/edit/id/'+id+'/g_id/'+g_id+'/url/'+url;
		$('img',this).fadeToggle(1000);
		$(this).find('.gallery-controls').remove();
		$(this).find('.gallery-controls').remove();
		$(this).append('<div class="well gallery-controls">'+
							'<p><a href="'+url+'" class="btn" id="'+id+'"><i class="icon-edit"></i></a> <a href="#" class="gallery-delete btn"><i class="icon-remove"></i></a></p>'+
						'</div>');
 ...
 var id = $(this).attr('id');
			 alert('id is-'+id);
			var url  =  base_url+'gallery_images/edit/id/'+id;
			alert(url);
			window.location=url;
	...
	$('.thumbnails').on('click','.gallery-delete',function(e){
		...
		e.preventDefault();
		$('#myModal_del_confirm_box').modal('show');
		// SHOW POPUP
	...
	$('.btn-close').click(function(e){
		...
		/*$('.attribute_list span').click(function(e){
			e.preventDefault();
			alert($(this).attr('id'));
			$(this).parent().fadeOut();
		});*/
 ...
 /* $('#review_reply_link').click(function(e){
	  
	  
		e.preventDefault();
		$('#reply_box_popup').modal('show');
             ...
             ajaxRequest.onreadystatechange = function(){
                      ...
                      if(ajaxRequest.readyState == 4){
						responseText = ajaxRequest.responseText;
							...
							if(responseText!=""){
							    document.getElementById('reply_data_div').innerHTML=responseText;
							}else{ 
							}
					...
					var domain =url+"/action/getReviewReply/id/"+reviewId+"/tblName/"+tblName+"";
